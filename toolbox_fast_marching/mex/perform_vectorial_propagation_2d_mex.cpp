...
#include "mex.h"
// Matlab
// W,start_points-1,end_points-1,nb_iter_max, H, L, values
void mexFunction(	int nlhs, mxArray *plhs[],
     ...
     * prhs:    Array of pointers to the input mxArrays. Do not modify
     * any prhs values in your MEX-file. Changing the data in these
     * read-only mxArrays can produce undesired side effects */
    ...
    /* cesar testing */
    /*mexPrintf("\n Cesar: There are %d right-hand-side argument(s).", nrhs);
    ...
    n = mxGetM(prhs[0]); // Number of rows in array
    p = mxGetN(prhs[0]); // Number of columns in array
    W = mxGetPr(prhs[0]); //Real data elements in array of type DOUBLE
    ...
    perform_vectorial_propagation_2d();
