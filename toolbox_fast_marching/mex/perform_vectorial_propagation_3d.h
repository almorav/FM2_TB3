#ifndef _PERFORM_VECTORIAL_PROPAGATION_3D_H_
#define _PERFORM_VECTORIAL_PROPAGATION_3D_H_
...
// main function
void perform_vectorial_propagation_3d(T_callback_intert_node callback_insert_node = NULL);

#endif // _PERFORM_VECTORIAL_PROPAGATION_3D_H_